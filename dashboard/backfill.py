...
STOCK_SYMBOLS = [
    ...
    for s in os.getenv(
        "STOCK_SYMBOLS",
        "AAPL,GOOGL,MSFT,AMZN,TSLA,NVDA,META,NFLX,AMD,INTC,JPM,V,WMT,JNJ,PG,MA,UNH,HD,BAC,DIS",
    ).split(",")
]
...
def main():
    ...
    print(
        f"Fetching historical data for {len(STOCK_SYMBOLS)} symbols using Yahoo Finance raw API..."
    )
